...
function Frame() {
  return (
    <div className='fixed z-6  '>
        <Link href="/" >
          <div className=" w-36 fixed top-[15px] left-[40px]">
    ...
    <div className="fixed  bottom-2 w-full flex items-center justify-center"><span><span className=" font-black">Photo</span>graphy</span></div>
</div>
  )
}
